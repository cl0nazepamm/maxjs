...
inline constexpr std::array<MaterialSlot, 23> kMaterialSlots = {{
    ...
    { SlotKind::Color,          L"sssMap",      L"sssMapXf",      &MaxJSPBR::sssColorMap,          &MaxJSPBR::sssColorMapTransform,          StrengthSource::None,           nullptr,       true  }, // material_builder.js applySSSMaterialNodes reads sssMap/sssColorMap
