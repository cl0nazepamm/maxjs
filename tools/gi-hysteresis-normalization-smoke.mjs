...
import {
    HYSTERESIS_DT_REF_MS,
    advanceReactiveTicks,
    hysteresisExponentForInterval,
    probeUpdateIntervalTicks,
} from '../web/vendor/speedball-gi/js/gi_probes.js';
...
const probeSource = readFileSync(new URL('../web/vendor/speedball-gi/js/gi_probes.js', import.meta.url), 'utf8');
