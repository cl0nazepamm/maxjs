// render_capture.js - editor render-to-image capture glue.
...
function createRenderCapture(deps = {}) {
        ...
        function beginRenderImageFrame(msg, responseType) {
            ...
            const wantsAlpha = msg.alpha === true && mimeSupportsAlpha(captureMime);
            ...
            // Hide all UI and keep only canvas elements visible.
            if (!wasAlreadyActive) {
                ...
                const captureBackdropColor = !wantsAlpha && deps.envVisible && !deps.getEnvironmentBackgroundMap()
                    ...
                    : 'transparent';
                document.body.style.background = captureBackdropColor;
