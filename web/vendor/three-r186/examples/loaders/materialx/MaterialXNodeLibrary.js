...
const mx_normalmap = (
	...
	// max.js: Max exports nested normalmap wrappers. The inner result is
	// already a world-space normal; do not decode it as a second RGB map.
	if ( value && value.isMaterialXNormalMapNode ) return value;
